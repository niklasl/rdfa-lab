...
graph.getByType('rdfs:Class').forEach(function (cls) {
  ...
  // cls.getAll('^rdfs:subClassOf') // SPARQL 1.1 inverse property path
  var subclasses = cls.getAllInverseOf('rdfs:subClassOf').map(
...
graph.getAll().forEach(function (node) {
